...
<!-- Mirrored from techydevs.com/demos/themes/html/disilab-demo/disilab/questions-layout-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 30 Jul 2023 12:56:00 GMT -->
...
<head>
    ...
    <!-- Favicon -->
    <link rel="icon" sizes="16x16" href="{{ asset('front-assets/images/favicon.png') }}">

    <!-- inject:css -->
    <link rel="stylesheet" href="{{ asset('front-assets/css/bootstrap.min.css') }}">
    <link rel="stylesheet" href="{{ asset('front-assets/css/line-awesome.css') }}">
    <link rel="stylesheet" href="{{ asset('front-assets/css/owl.carousel.min.css') }}">
    <link rel="stylesheet" href="{{ asset('front-assets/css/owl.theme.default.min.css') }}">
    <link rel="stylesheet" href="{{  asset('front-assets/css/jquery-te-1.4.0.css')}}">
    <link rel="stylesheet" href="{{ asset('front-assets/css/selectize.css') }}">
    ...
    <header class="header-area bg-white shadow-sm">
                ...
                <div class="col-lg-2">
                    <div class="logo-box">
                        <a href="index.html" class="logo">
                            Logo
                            {{-- <img src="{{  asset('front-assets/images/logo-black.png')}}" alt="logo"></a> --}}
        ...
        <div class="off-canvas-menu custom-scrollbar-styled">
            ...
            <div class="off-canvas-btn-box px-4 pt-5 text-center">
                ...
                <a href="#" class="btn theme-btn theme-btn-sm" data-toggle="modal"
                    data-target="#signUpModal"><i class="la la-plus mr-1"></i> Sign up</a>
            </div>
            ...
            <div class="row align-items-center pb-4 copyright-wrap">
                <div class="col-lg-6">
                    <a href="index.html" class="d-inline-block">
                        <img src="{{ asset('front-assets/images/logo-white.png') }}" alt="footer logo"
                            class="footer-logo">
                    </a>
                </div><!-- end col-lg-6 -->
                <div class="col-lg-6">
...
================================= -->
    ...
    <script src="{{ asset('front-assets/js/jquery-te-1.4.0.min.js') }}"></script>
    <script src="{{ asset('front-assets/js/selectize.min.js') }}"></script>
    <script src="{{ asset('front-assets/js/jquery.multi-file.min.js') }}"></script>
