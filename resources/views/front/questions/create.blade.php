                        ...
                        >
                            ...
                            <div class="input-box">
                                ...
                                <div class="form-group">
                                    <input required class="form-control form--control" type="text" name="title"
                            ...
                            <div class="input-box">
                                <div class="d-flex align-items-center justify-content-between">
                                    ...
                                    <button type="button" class="popover-trigger btn border border-gray py-1 lh-18 px-2"
                                        ...
                                        <svg aria-hidden="true" class="svg-icon-color-gray" width="14"
                                            height="14">
                                            <path
                                    ...
                                    <div class="generic-popover d-none">
                                        ...
                                        <ul class="generic-list-item generic-list-item-bullet">
                                            <li class="lh-18 text-black-50">Identify your tags by completing the sentence,
                                                "My question is about…"</li>
                                            <li class="lh-18 text-black-50">Include tags that are crucial to your question
                                                only, like <div class="tag-link">c#</div>
                                            </li>
                                        ...
                                        <p class="fs-14 text-black-50"><a href="#"
                                                class="text-color hover-underline" target="_blank">Create new tags</a> or
                                            post without it and <a href="#" class="text-color hover-underline"
                                                target="_blank">ask the community</a>
                                            to create one for you.
                                        </p>
                                    </div><!-- end generic-popover -->
                                </div>
                                <div class="form-group">
                                    <input required class="" type="text" name="tags"
                                        placeholder="e.g. javascript" id="inputTags">
                                </div>
                            </div><!-- end input-box -->
                            <div class="input-box">
                                ...
                                <p class="fs-13 pb-3 lh-20">Please choose the appropriate section so the question can be
                                    searched easily.</p>
                                <div class="form-group">
                                    <select required class="select-container select--container"
                            ...
                            <div class="input-box">
                                <label class="fs-14 text-black fw-medium">Images</label>
                                <div class="form-group">
                            ...
                            <div class="input-box pt-2">
                                ...
                                <div class="btn-box">
                                    <button type="button" onclick="addPoll()" class="btn btn-md btn-secondary">Add a poll?</button>
                                    <p>
                                        {{ __('Poll expire automatically in '). config("app.poll_expire_days") }}
                                    </p>
                                </div>
                            </div>

                            <div class="input-box mt-2 d-none" id="pollContainer">
                                <button type="button" class="btn btn-success btn-sm" onclick="addPollOption()">Add</button>

                                <div class="table-responsive">

                                    <table class="table table-bordered" id="polls">
                                        <thead>
                                            <tr>
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>
                                                    <input type="text" required class="form-control form--control" name="polls[]">
                                                </td>
                                                <td>
                                                    <button type="button" class="btn btn-danger btn-sm" onclick="removePollOption(this)">Delete</button>
...
<script>
    ...
    function addPollOption(){
        $("#polls tbody").append(`
            <tr>
                <td>
                    <input required type="text" class="form-control form--control" name="polls[]">
                </td>
                <td>
                    <button type="button" class="btn btn-danger btn-sm" onclick="removePollOption(this)">Delete</button>
